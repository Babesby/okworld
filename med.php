<?php
$pagename = "Medical Tour / Procedure";
include("header.php");
?>
<style>
...
<section id="services" class="construction">
                ...
                <div class="heading">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Medical Tour</li>
                        </ol>
                    </nav>
                    <h1 class="about_watermark">Procedure</h1>
                </div>
